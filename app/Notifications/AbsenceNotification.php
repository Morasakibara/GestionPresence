...
class AbsenceNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        if ($notifiable->role === 'Administrateur') {
            ...
            $subject = 'Notification d\'absence d\'un membre de votre équipe';
        ...
        return (new MailMessage)
                    ->subject($subject)
                    ->greeting($greeting)
                    ->line('Un employé a été marqué absent.')
    ...
    public function toArray(object $notifiable): array
    {
        ...
        if ($notifiable->role === 'Superviseur') {
            // Vérifier si l'employé absent fait partie de l'équipe du superviseur
        ...
        return [
            ...
            'date' => $this->date,
            'message' => $messagePrefix . 'L\'employé ' . $this->employe->nom . ' a été marqué absent le ' . $this->date,
