...
12. **Timeline de présence** : l'employé consulte l'**historique complet** d'une de ses présences (`/user/presence-history/{id}`) : arrivée, départ, suspicion (motif, distance, vitesse), contestation, réponse de l'admin et changements de statut — chronologie visuelle depuis son bilan.
