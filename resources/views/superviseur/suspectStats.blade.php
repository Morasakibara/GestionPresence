...
<div class="container px-4 py-6 mx-auto sm:px-6 lg:px-8">
    <div class="mb-6 flex flex-wrap items-start justify-between gap-4">
        ...
        <a href="{{ route('superviseur.suspectStats.pdf') }}" class="inline-flex items-center gap-2 rounded-md bg-3hcig-blue px-4 py-2 text-sm font-medium text-white hover:bg-3hcig-blue-light">
    ...
    <div class="mt-6 rounded-lg bg-white p-6 shadow-sm">
        <h2 class="text-lg font-bold text-3hcig-blue-dark">Détail par membre de l'équipe</h2>
        @if($detailParEmploye->isEmpty())
            <p class="mt-4 text-sm text-gray-500">Aucune présence suspecte dans votre équipe — le tableau sera vide.</p>
        @else
