...
<head>
    <meta charset="UTF-8">
    <title>Statistiques des suspicions — Équipe</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="header">
            <h1>Statistiques des suspicions — Équipe</h1>
            <p>Équipe: {{ $equipe ?? '—' }}</p>
        ...
        <div class="cards">
            ...
            <div class="card">
                <div class="label">Membres bloqués</div>
        ...
        <div class="section">
            <h2>Contestations des membres</h2>
            <table>
        ...
        <div class="section">
            ...
            @if($detailParEmploye->isEmpty())
                <p style="color:#6b7280;">Aucune présence suspecte dans l'équipe.</p>
            @else
                <table>
                    <thead>
                        <tr>
                            <th>Membre</th><th>Total</th><th>En attente</th>
