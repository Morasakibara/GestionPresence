...
@section('header')
<div class="flex items-center justify-between"><span>Commandes — Directrice</span></div>
@endsection
        ...
        <div class="table-scroll">
            <table class="min-w-full">
                ...
                <tbody class="table-body">
                    ...
                    @empty
                        <tr><td colspan="5" class="px-6 py-12 text-center text-sm text-gray-400">Aucune commande enregistrée aujourd'hui</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
