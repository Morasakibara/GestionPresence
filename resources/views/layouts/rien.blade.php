...
<body class="h-full">
    ...
    <div class="flex flex-col h-full md:flex-row">
        ...
        <div class="block p-3 text-white md:hidden bg-3hcig-blue-dark">
            <button id="mobile-menu-button" class="flex items-center" aria-expanded="false" aria-controls="sidebar">
        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 text-white transition-transform duration-300 ease-in-out transform -translate-x-full bg-3hcig-blue-dark md:translate-x-0 md:static md:flex md:flex-col md:h-screen">
            ...
            <!-- Nav Links -->
            <nav class="flex flex-col flex-1 px-2 mt-5 overflow-y-auto">
        ...
        <div class="flex flex-col flex-1 md:pl-64">
            ...
            <!-- Main Content Area -->
            <main class="flex-1 p-4 bg-gray-100 sm:p-6 lg:p-8">
