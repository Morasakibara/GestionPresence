        ...
        <div class="overflow-hidden rounded-lg bg-white shadow-sm">
            <div class="px-4 py-5 sm:p-6">
                <div class="flex flex-col items-center">
                    ...
                    <div class="mb-6 flex flex-col items-center">
                        @if($user->avatar)
                            <div class="mb-3 h-32 w-32 overflow-hidden rounded-full border-4 border-3hcig-blue-light">
                                <img src="{{ asset('storage/avatars/' . $user->avatar) }}" alt="Avatar" class="h-full w-full object-cover">
                            </div>
                        @else
                    ...
                    <form action="{{ route('admin.updateProfile') }}" method="POST" enctype="multipart/form-data" class="w-full space-y-6">
                        @csrf
                        @method('POST')
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" id="name" name="nom" value="{{ $user->nom }}" required
